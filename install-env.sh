...
aws ec2 run-instances --image-id ami-8b77d1eb --key-name test --security-group-ids sg-b5488acc --instance-type t2.micro --user-data file://install-app1.sh --iam-instance-profile Name=developer
