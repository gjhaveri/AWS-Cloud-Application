...
aws autoscaling create-launch-configuration --launch-configuration-name ubuntuserver --image-id ami-06b94666 --key-name test --security-groups sg-b5488acc --instance-type t2.micro --user-data  file://installenv.sh
